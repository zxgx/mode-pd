...
#     --compressed_model_save_path iclr_rebuttal/variant_ablation_var/$dataset-$sample_size/$model_id-mone-pruned-48
# EOF
...
#     --expert_prune_metric mone --mone_ranking_metric output_fluctuation \
#     --zero_out_novice --max_steps $sample_size \
#     --compressed_model_save_path iclr_rebuttal/variant_ablation_var/$dataset-$sample_size/$model_id-mone-pruned-32
# EOF
...
for sample_size in 500 1000; do
