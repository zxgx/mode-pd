...
#     --expert_prune_metric mone --mone_ranking_metric fusion \
#     --compressed_model_save_path iclr_rebuttal/pruned_instruct_model/$model_id-mone-pruned-32 \
#     --dump_stats_path iclr_rebuttal/pruned_instruct_model/$model_id-mone-pruned-32-stats.pt
# EOF
