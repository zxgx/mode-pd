...
python modepd/prune.py --model_name_or_path $model_id $data_config \
    ...
    --compressed_model_save_path exp/mone_io_fluctuationn_model/$model_id-mone-pruned-48

python modepd/prune.py --model_name_or_path $model_id $data_config \
    --expert_prune --preserve_n_experts 32 --expert_ranking_scope model \
    --expert_prune_metric mone --mone_ranking_metric io_fluctuation \
    --compressed_model_save_path exp/mone_io_fluctuationn_model/$model_id-mone-pruned-32
