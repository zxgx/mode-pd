...
python modepd/prune.py --model_name_or_path $model_id $data_config \
    ...
    --compressed_model_save_path exp/mone_io_fluctuation_evolve_layer/$model_id-mone-pruned-48

python modepd/prune.py --model_name_or_path $model_id $data_config \
    --expert_prune --preserve_n_experts 32 --expert_ranking_scope layer \
    --expert_prune_metric mone --mone_ranking_metric io_fluctuation --enable_novice_evolving \
    --compressed_model_save_path exp/mone_io_fluctuation_evolve_layer/$model_id-mone-pruned-32
