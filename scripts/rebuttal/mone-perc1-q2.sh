...
python modepd/prune.py --model_name_or_path Qwen/$model_id $data_config \
    --expert_prune --preserve_n_experts 46 --expert_ranking_scope layer \
    --expert_prune_metric mone --mone_ranking_metric fusion \
    --compressed_model_save_path exp/mone_rs_out_fusion_layer/$model_id-mone-pruned-46

python modepd/prune.py --model_name_or_path Qwen/$model_id $data_config \
    --expert_prune --preserve_n_experts 44 --expert_ranking_scope layer \
    --expert_prune_metric mone --mone_ranking_metric fusion \
    --compressed_model_save_path exp/mone_rs_out_fusion_layer/$model_id-mone-pruned-44
EOF
