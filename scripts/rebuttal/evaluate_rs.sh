...
#     --hf_model exp/routing_score_model/$model_id-pruned-96 \
#     --tasks $EVAL_TASKS --num_fewshots $EVAL_FEWSHOTS \
#     --batch_size 8 --trust_remote_code --output_dir exp/routing_score_model
# EOF

# singularity exec --nv $image bash << EOF
# source $HPCTMP/venvs/mone/bin/activate
# torchrun --standalone --nproc_per_node $GPUS_PER_NODE modepd/eval.py \
#     --hf_model exp/routing_score_model/$model_id-pruned-64 \
#     --tasks $EVAL_TASKS --num_fewshots $EVAL_FEWSHOTS \
#     --batch_size 8 --trust_remote_code --output_dir exp/routing_score_model
# EOF
...
# source $HPCTMP/venvs/mone/bin/activate
# torchrun --standalone --nproc_per_node $GPUS_PER_NODE modepd/eval.py \
#     --hf_model exp/routing_score_model/$model_id-pruned-48 \
#     --tasks $EVAL_TASKS --num_fewshots $EVAL_FEWSHOTS \
#     --batch_size 8 --trust_remote_code --output_dir exp/routing_score_model
# EOF
...
source $HPCTMP/venvs/mone/bin/activate
torchrun --standalone --nproc_per_node $GPUS_PER_NODE modepd/eval.py \
    --hf_model exp/routing_score_model/$model_id-pruned-32 \
    --tasks $EVAL_TASKS --num_fewshots $EVAL_FEWSHOTS \
    --batch_size 8 --trust_remote_code --output_dir exp/routing_score_model
EOF